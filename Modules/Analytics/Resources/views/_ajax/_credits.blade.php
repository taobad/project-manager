<div class="table-responsive">
	<table id="table-credits" class="table table-striped">
		...
		<tbody>
			...
			<tr>
				<td><a href="{{ route('creditnotes.view', $creditnote->id) }}">{{ $creditnote->reference_no }}</a></td>
				<td><a href="{{ route('clients.view', $creditnote->client_id) }}">{{ optional($creditnote->company)->name }}</a></td>
