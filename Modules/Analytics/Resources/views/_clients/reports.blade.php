                                ...
                                <div class="row wrapper analytics">
                                    <div class="col-sm-12 m-b-xs">
                                        <form>
                                            ...
                                            <a class="btn {{themeButton()}}" type="submit">
                                                @langapp('go')
                                            </a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped b-t b-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{{ route('clients.view', $client->id) }}">{{ $client->name }}</a></td>
                                                <td>{{ optional($client->contact)->name }}</td>
                                                <td><a href="{{ route('clients.email', $client->id) }}" data-toggle="ajaxModal">{{ $client->email }}</a></td>
                                                <td>{{ $client->city }}</td>
