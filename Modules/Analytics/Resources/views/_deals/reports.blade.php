                                    ...
                                    <form class="ajax-filter">
                                        ...
                                        <div class="inline v-middle">
                                            ...
                                            <select class="form-control input-s-sm" id="filter-pipeline" name="pipeline">
                                                ...
                                                <option value="{{ $pipeline->id }}" {{ $pipeline->id == get_option('default_deal_pipeline') ? 'selected' : '' }}>
                                                    {{ ucfirst($pipeline->name) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="inline v-middle">
                                            ...
                                            <select class="form-control input-s-sm" name="stage_id" id="filter-stage">
                                                ...
                                                <option value="{{ $dealStage->stage_id }}" {{ $dealStage->stage_id == get_option('default_deal_stage') ? 'selected' : '' }}>
                                                    {{ optional($dealStage->category)->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="inline v-middle">
                                            ...
                                            <select class="form-control input-s-sm" name="owner" id="filter-owner">
                                                ...
                                                <option value="{{ $dealOwner->user_id }}" {{ $dealOwner->user_id == get_option('default_deal_owner') ? 'selected' : '' }}>
                                                    {{ optional($dealOwner->user)->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="inline v-middle">
