<div class="modal-dialog" id="eventModal">
    <div class="modal-content">
        ...
        {!! Form::open(['route' => ['appointments.api.update', $appointment->id], 'class' => 'bs-example form-horizontal ajaxifyForm', 'data-toggle' => 'validator', 'method' =>
        'PUT']) !!}
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group date">
                        <input type="text" class="form-control datetimepicker-input" value="{{  timePickerFormat($appointment->start_time) }}" name="start_time"
                            data-date-format="{{ strtoupper(get_option('date_picker_format')) }} hh:mm A" data-date-start-date="0d" required>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group date">
                        <input type="text" class="form-control datetimepicker-input" value="{{  timePickerFormat($appointment->finish_time) }}" name="finish_time"
                            data-date-format="{{ strtoupper(get_option('date_picker_format')) }} hh:mm A" data-date-start-date="0d" required>
                        <div class="input-group-addon">
                            @icon('solid/calendar-alt', 'text-muted')
                        </div>
            ...
            <div class="checkbox">
                <label>
                    ...
                    <span class="font-semibold text-red-600 label-text">@langapp('mark_as_deleted')</span>
                </label>
            </div>
