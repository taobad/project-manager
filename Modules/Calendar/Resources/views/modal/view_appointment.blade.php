<div class="modal-dialog">
    <div class="modal-content">
            ...
            <ul class="list-group no-radius">
                ...
                <li class="list-group-item">
                    <div class="text-sm pull-right">
                        <img src="{{ $appointment->user->profile->photo }}" class="inline w-5 rounded-full">
                        <span class="align-middle">{{ $appointment->user->name }}</span>
                    </div>
                    @langapp('user')
                </li>
                ...
                <li class="list-group-item">
                    <span class="pull-right">
                        <a href="{{  route('leads.view', ['lead' => $appointment->lead_id]) }}">
        ...
        <div class="modal-footer">
            ...
            <a href="{{  route('calendar.edit.appointment', ['id' => $appointment->id])  }}" class="btn {{themeButton()}} text-white" data-toggle="ajaxModal"
