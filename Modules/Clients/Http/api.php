...
Route::group(
    ['middleware' => 'auth:api', 'prefix' => 'api/v1', 'namespace' => 'Modules\Clients\Http\Controllers\Api\v1'],
    function () {
        ...
        Route::get('clients/{id}/credits', 'ClientsApiController@credits')->middleware('can:menu_clients');
