...
Route::group(
    ...
    function () {
        ...
        Route::post('bulk-delete', 'ClientCustomController@bulkDelete')->name('clients.bulk.delete')->middleware(['can:clients_delete', 'demo']);
        Route::delete('destroy/{client}', 'ClientCustomController@destroy')->name('clients.destroy')->middleware(['can:clients_delete', 'demo']);
