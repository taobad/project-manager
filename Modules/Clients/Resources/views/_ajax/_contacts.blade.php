@foreach ($contacts->chunk(4) as $chunk)
    ...
    <p class="m-t-sm">
      ...
      @can('clients_update')
                        <a href="{{ route('contacts.primary', ['client' => $contact->company, 'user' => $contact->user_id]) }}"
                        ...
                        <a href="{{  route('contacts.edit', $contact->user_id)  }}"
      ...
      @endcan
        ...
        @can('users_delete')
                                <a href="{{  route('users.delete', $contact->user_id) }}"
