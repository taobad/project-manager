        ...
        <div class="panel invoice-grid widget-b">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-semibold"><a href="{{  route('estimates.view', ['estimate' => $estimate->id])  }}">#{{  $estimate->reference_no  }}</a>
                        </h6>
            ...
            <div class="panel-footer panel-footer-condensed">
                ...
                <div class="heading-elements">
                    <span class="heading-text">
                        @icon('solid/calendar-alt', 'text-danger') @langapp('due_date') : <span class="text-semibold">{{  dateFormatted($estimate->due_date)  }}</span>
                    </span>

                    <a href="{{  route('estimates.view', ['estimate' => $estimate->id])  }}" class="btn {{themeButton()}} pull-right">
