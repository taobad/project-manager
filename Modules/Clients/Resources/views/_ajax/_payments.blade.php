        ...
        <div class="panel invoice-grid widget-b">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-semibold"><a href="{{  route('payments.view', ['payment' => $payment->id])  }}">#{{  $payment->code  }}</a>
                        </h6>
            ...
            <div class="panel-footer panel-footer-condensed">
                ...
                <div class="heading-elements">
                    ...
                    <a href="{{  route('payments.view', $payment->id)  }}" class="btn {{themeButton()}} pull-right">
