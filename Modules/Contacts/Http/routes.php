...
Route::group(
    ...
    function () {
        ...
        Route::post('data', 'ContactCustomController@tableData')->name('contacts.data')->middleware('can:contacts_view');
        Route::get('view/{user}/{tab?}', 'ContactCustomController@view')->name('contacts.view')->middleware('can:contacts_view');
        ...
        Route::post('bulk-email', 'ContactCustomController@bulkEmail')->name('contacts.bulk.email')->middleware('can:contacts_update');
        Route::post('bulk-sms', 'ContactCustomController@bulkSms')->name('contacts.bulk.sms')->middleware('can:contacts_update');
        Route::post('bulk-send', 'ContactCustomController@sendBulk')->name('contacts.bulk.send');
        Route::post('bulk-send-sms', 'ContactCustomController@sendBulkSms')->name('contacts.bulk.send.sms');
    }
);
