            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control select2-option" name="country">
                        <option value="{{get_option('company_country')}}" {{is_null($contact->profile->country) ? 'selected' : ''}}>{{get_option('company_country')}}</option>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="select2-tags form-control" name="tags[]" multiple>
                        ...
                        <option value="{{ $tag->name }}" {{ in_array($tag->id, array_pluck($contact->tags->toArray(), 'id')) ? ' selected' : '' }}>
                            {{ $tag->name }}
                        </option>
                        @endforeach
                    </select>
