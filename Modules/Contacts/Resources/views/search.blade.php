    ...
    <header class="header bg-white b-b clearfix">
      <div class="row m-t-sm">
        ...
        <div class="col-sm-7 m-b-xs">
          ...
          @endcan
          @can('contacts_view')
          <a href="{{ route('contacts.export') }}" class="btn {{themeButton()}} pull-right">
          ...
          <div class="thumbnail">
            ...
            <div class="caption text-center">
              ...
              <p class="m-t-sm">
                ...
                @endif
                <a href="{{ route('contacts.email', $contact->user_id) }}" class="btn btn-rounded btn-dracula btn-icon" data-toggle="ajaxModal" data-rel="tooltip"
                  title="@langapp('send_email')">@icon('solid/paper-plane')</a>
