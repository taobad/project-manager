...
Route::group(
    ...
    function () {
        ...
        Route::get('templates', 'ContractCustomController@templates')->name('contracts.templates')->middleware('can:contracts_create');
        Route::post('templates', 'ContractCustomController@saveTemplate')->name('contracts.saveTemplate')->middleware('can:contracts_create');
        Route::get('templates/edit/{template}', 'ContractCustomController@editTemplate')->name('contracts.editTemplate')->middleware('can:contracts_create');
        Route::post('templates/update/{template}', 'ContractCustomController@updateTemplate')->name('contracts.updateTemplate')->middleware('can:contracts_create');
        Route::delete('templates/{template}', 'ContractCustomController@deleteTemplate')->name('contracts.deleteTemplate')->middleware('can:contracts_create');
    }
);
