            ...
            <header class="clearfix bg-white header b-b">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        <a href="{{ route('contracts.view', $contract->id)}}" class="btn {{themeButton()}}">
                            @icon('solid/arrow-alt-circle-left') @langapp('preview')
                        </a>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{  $contract->contract_title}}" name="contract_title" class="form-control" required>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="client_id" class="form-control select2-option" required>
                                            ...
                                            <option value="{{  $client->id}}" {{  $client->id === $contract->client_id ? 'selected="selected"' : '' }}>{{ $client->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label>Contract Template @required</label>
                                        <select name="template_id" class="form-control">
                                            @foreach (Modules\Contracts\Entities\ContractTemplate::get() as $template)
                                            <option value="{{ $template->id }}" {{ $contract->template_id == $template->id ? 'selected' : '' }}>{{ $template->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="datepicker-input form-control" size="16" type="text" value="{{  datePickerFormat($contract->start_date)}}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input class="datepicker-input form-control" size="16" type="text" value="{{  datePickerFormat($contract->end_date)}}" name="end_date"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" value="{{ $contract->fixed_rate }}" class="form-control" name="fixed_rate">
                                    </div>
                                    <div class="col-md-4">
                                        <label>@langapp('hourly_rate') </label>
                                        <input type="text" value="{{ $contract->hourly_rate }}" class="form-control" name="hourly_rate">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="currency" class="form-control select2-option" required>
                                            ...
                                            <option value="{{  $currency['code']}}" {{  $currency['code'] == $contract->currency ? 'selected="selected"' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="services" value="{{  $contract->services}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{  diffDays($contract->start_date, $contract->expiry_date)}}" class="form-control" name="expiry_date" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <x-inputs.wysiwyg name="description" class="{{ get_option('htmleditor') }}" id="contract_description">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-inputs.wysiwyg name="client_rights" class="{{ get_option('htmleditor') }}" id="client_rights">
                                            {!! $contract->client_rights!!}
                                        </x-inputs.wysiwyg>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" value="{{  $contract->payment_terms}}" class="form-control" name="payment_terms">
                                        <span class="help-block text-danger">Enter number of Days</span>
                                    </div>
                                    <div class="col-md-4">
                                        <label>@langapp('late_fee')</label>
                                        <input type="text" value="{{  $contract->late_payment_fee}}" name="late_payment_fee" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" value="{{  $contract->termination_notice}}" class="form-control" name="termination_notice">
                                        <span class="help-block text-danger">Enter number of Days</span>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" value="{{ $contract->cancelation_fee }}" class="form-control" name="cancelation_fee">
                                    </div>
                                    <div class="col-md-3">
                                        <label>@langapp('required_deposit') <a href="#" data-toggle="tooltip" data-placement="top"
                                        ...
                                        <input type="text" value="{{ $contract->deposit_required }}" name="deposit_required" class="form-control">
                                    </div>
