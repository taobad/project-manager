...
{
    use Observable, Taggable, Actionable, Todoable, Commentable, Customizable, Noteable, Eventable,
    Uploadable, BelongsToUser, Searchable, Remindable, Phoneable, Emailable, Itemable, HasFactory;
    ...
    {
        return $this->belongsTo(User::class, 'contact_person', 'id')->with('profile:user_id,mobile,avatar');
    }
