	...
	<aside>
		<section class="">
			...
			<header class="header">
				...
				<a href="{{ route('todo.create', ['module' => 'deals', 'id' => $deal->id]) }}" data-toggle="ajaxModal" class="btn {{themeButton()}} pull-right btn-icon"
					id="new-task">
					@icon('solid/plus')
				</a>
			...
			<div class="progress progress-xxs progress-striped">
				<div class="progress-bar progress-bar-success" data-toggle="tooltip" data-original-title="{{ $deal->percent_done }}%" data-placement="bottom"
					style="width: {{ $deal->percent_done }}%">
				</div>
			</div>
					...
					<article class="chat-item" id="chat-form">
						...
						<section class="chat-body">
							...
							<div class="input-group">
								<input type="text" class="form-control" name="subject" placeholder="Follow up on deal {{ $deal->title }} [next monday]">
