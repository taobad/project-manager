    ...
    <div class="col-lg-4 b-r">
        <section class="panel panel-default">
            ...
            <section class="panel-body">
                ...
                <div class="m-xs">
                    <span class="">{{ $deal->contact->profile->mobile }}</span>
                    <a href="web+aircall:{{ $deal->contact->profile->mobile }}" data-rel="tooltip" title="@langapp('call_via_aircall')">@icon('solid/phone','text-success')</a>
                </div>
