    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <textarea name="description" class="form-control ta"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <div class="input-group iconpicker-container">
                        ...
                        <input id="icon" name="icon" type="text" value="fas fa-book" class="form-control iconpicker-input" data-placement="bottomRight">
                    </div>
                </div>
            </div>
            ...
            <ul class="list-group gutter list-group-lg list-group-sp sortable" id="categoryList">
                ...
                <li class="list-group-item" draggable="true" id="cat-{{ $category->id }}">
                    ...
                    <div class="clear"><i class="fas fa-{{$category->icon}}"></i> {{ $category->name }} </div>
                </li>
                @endforeach
