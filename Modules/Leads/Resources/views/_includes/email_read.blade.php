...
<div class="padder m-t">
    <div class="block clearfix m-b">
        ...
        <div class="inline pull-right">{{ dateTimeFormatted($email->created_at) }} (<span class="small">{{ dateElapsed($email->created_at) }}</span>)
            ...
            <li>
                ...
                <div class="mail-attachments-content">
                    ...
                    <ul class="list-inline list-inline-condensed no-margin">
                        ...
                        <li><a href="{{ route('files.delete', $file->id) }}" data-toggle="ajaxModal">
                                @langapp('delete')
                            </a>
                        </li>
                    </ul>
