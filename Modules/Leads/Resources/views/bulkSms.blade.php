        ...
        <section class="scrollable wrapper bg">
          <div class="panel panel-body">
            ...
            <section class="panel panel-default">
              ...
              {!! Form::open(['route' => 'leads.bulk.send.sms', 'class' => 'bs-example ajaxifyForm', 'data-toggle' => 'validator']) !!}
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <select class="select2-option width100" multiple="multiple" name="leads[]">
                    ...
                    <option value="{{ $lead->id }}" selected>{{ $lead->name }} &laquo;{{ $lead->mobile }}&raquo;</option>
                    @endforeach
                  </select>
                </div>
