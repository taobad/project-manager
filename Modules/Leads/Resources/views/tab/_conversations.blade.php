      ...
      <section class="chat-body">
        ...
        <div class="form-group display-none" id="queueLater">
          ...
          <div class="input-group date">
            <input type="text" class="form-control datetimepicker-input" value="{{  timePickerFormat(now()) }}" name="reserved_at"
        ...
        <article id="message-{{$message->id}}" class="chat-item {{ $message->from == $lead->sales_rep ? 'left' : 'right' }}">
          ...
          <section class="chat-body comment-body">
            <div class="panel b-light m-b-none">
              <header class="bg-white panel-heading b-b">
              ...
              <div class="panel-body">
                ...
                <span class="message-data-name text-muted">
                  ...
                  <i class="fas fa-{{ $message->opened > 0 ? 'envelope-open text-success' : 'envelope text-danger'  }}" data-rel="tooltip"
                    title="{{ $message->opened >= 1 ? 'Email Viewed' : 'Not Viewed' }}"></i>
                  @endif
                </span>
