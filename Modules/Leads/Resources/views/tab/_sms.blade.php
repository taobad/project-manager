        ...
        <section class="" id="taskapp">
            <aside>
                <section class="">
                    ...
                    <section class="panel panel-default">
                        <header class="panel-heading">SMS @langapp('messages') from {{ $lead->name }}
                        ...
                        <section class="bg chat-list panel-body">
                            ...
                            <section class="panel panel-default">
                                ...
                                @widget('Chats\CreateSmsWidget', ['chatable_type' => 'leads' , 'chatable_id' => $lead->id, 'cannedResponse' => true])
                            ...
                            @asyncWidget('Chats\Sms', ['chatable_id' => $lead->id, 'chatable_type' => 'leads'])
