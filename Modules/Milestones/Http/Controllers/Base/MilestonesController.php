...
class MilestonesController extends Controller
{
    ...
    public function update(MilestoneRequest $request, Milestone $milestone)
    {
        ...
        $data['redirect'] = route('projects.view', ['project' => $milestone->project_id, 'tab' => 'milestones', 'item' => $milestone->id]);
    ...
    public function save(MilestoneRequest $request)
    {
        ...
        $data['redirect'] = route('projects.view', ['project' => $milestone->project_id, 'tab' => 'milestones']);
    ...
    public function destroy(Request $request, Milestone $milestone)
    {
        ...
        return redirect()->route('projects.view', ['project' => $milestone->project_id, 'tab' => 'milestones']);
    }
}
