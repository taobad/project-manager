...
{
    use SoftDeletes, Actionable, Commentable, Taggable, Observable, Uploadable, Eventable, Searchable, HasFactory;
    ...
    {
        return $this->AsInvoice->isClient() || \Auth::user()->can('payments_view_all');
    }
