  ...
  <div class="row no-margin h-fullscreen p-t2">
    <div class="col-12">
      <div class="mx-auto text-center card card-transparent">
        <h1 class="text-secondary text-success font200">✓</h1>

        <h3 class="text-uc">Direct Debit set up successfully</h3>
        <p>
          {{get_option('company_name')}} will appear on your bank statement when payments are taken against this Direct Debit.
        </p>
        <div class="m-md">
          <a href="{{ route('invoices.view',$invoice_id) }}" class="btn {{themeButton()}}">
            @icon('solid/file-invoice-dollar') @langapp('invoice')</a>
    ...
    <footer class="text-center col-12 fs-13">
      <p>
        <img src="{{ getStorageUrl(config('system.media_dir').'/gocardless.png') }}" width="200" alt="Gocardless">
      </p>
    </footer>
