<div class="modal-dialog">
    <div class="modal-content">
        ...
        {!! Form::open(['route' => ['payments.api.update', $payment->id], 'class' => 'bs-example form-horizontal ajaxifyForm', 'files' => true, 'method' => 'PUT', 'data-toggle' =>
        'validator']) !!}
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" value="{{  $payment->amount  }}" name="amount" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        <input class="datepicker-input form-control" size="16" type="text" value="{{  datePickerFormat($payment->payment_date)  }}" name="payment_date"
