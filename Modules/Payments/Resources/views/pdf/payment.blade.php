        ...
        <tbody>
            <tr class="">
                <td class="text-left width60">
                    ...
                    {!! nl2br(langapp('invoice_amount') . ': ' . formatCurrency($payment->AsInvoice->currency, $payment->AsInvoice->payable())) . '<br />' . langapp('balance') . ':
                    ' . formatCurrency($payment->AsInvoice->currency, $payment->AsInvoice->due()) !!}
