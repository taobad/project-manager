...
Route::group(
    ...
    function () {
        ...
        Route::post('menu/icon/{module}', 'SettingController@menuIcon')->name('menu.icon')->middleware(['can:settings_update', 'demo']);
        ...
        Route::post('test/mail', 'SettingController@sendMail')->name('settings.send.mail')->middleware(['can:settings_update', 'demo']);
