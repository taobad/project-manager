                ...
                <ul class="list no-style" id="clauses-list">
                    ...
                    <li class="panel panel-default" id="clause-{{ $clause->id }}">
                        <div class="panel-heading">
                            <a class="accordion-toggle name" data-toggle="collapse" data-parent="#accordion2" href="#{{ clean(slugify($clause->name)) }}">
                        ...
                        <div id="{{ clean(slugify($clause->name)) }}" class="panel-collapse collapse">
