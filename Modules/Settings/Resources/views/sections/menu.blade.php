                    ...
                    <tr class="sortable" data-module="{{  $adm->module  }}" data-access="1">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <button data-toggle="dropdown" data-selected="{{  $adm->icon  }}" class="menu-icon icp icp-dd btn btn-default dropdown-toggle" type="button"
                                    aria-expanded="false" data-role="1" data-href="{{  route('menu.icon', ['module' => $adm->module])  }}">
                        ...
                        <td>
                            <a data-toggle="tooltip" title="@langapp('toggle')" class="menu-view-toggle btn {{ $adm->visible == 1 ? 'btn-info' : 'btn-default'  }}" href="#"
                                data-role="1" data-href="{{ route('menu.visible', ['module' => $adm->module]) }}">
                                @icon('solid/eye')
                            </a>
                        </td>
                    </tr>
