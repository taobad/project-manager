    ...
    public function toMail($notifiable)
    {
        if ($notifiable->channelActive('mail', $this->type)) {
            return (new MailMessage)
                ...
                ->subject(langmail('tasks.commented.subject', ['project' => $this->task->AsProject->name]))
                ->line(langmail('tasks.commented.body', ['name' => $this->task->name]))
                ->action('View Comment', route('projects.view', ['project' => $this->task->AsProject->id, 'tab' => 'tasks', 'item' => $this->task->id]));
        }
    }
