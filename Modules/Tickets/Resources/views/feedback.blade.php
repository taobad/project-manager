...
<body class="bg">
    <div class="text-center vbox">
        <section class="container-fluid">
            <section id="content">
                <div class="wrapper rating scrollable">
                    <a href="{{ route('tickets.index') }}" class="btn {{themeButton()}}">
                        @icon('solid/home') {{ get_option('company_name') }}
                    </a>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="message" class="form-control ta"></textarea>
                    </div>
