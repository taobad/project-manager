            ...
            <header class="clearfix bg-white header b-b">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        <a href="{{ route('tickets.view', $ticket->id) }}" title="Back to Ticket" data-rel="tooltip" data-placement="right" class="btn {{themeButton()}}">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{  $ticket->subject  }}" name="subject" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <span class="label-text" data-rel="tooltip"
                                                title="Ticket reporter will not be asked to give feedback on this ticket">@langapp('disable_feedback')</span>
                                        </label>
                                    </div>
                                </div>
                                @endadmin
