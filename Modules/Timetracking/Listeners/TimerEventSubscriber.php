...
class TimerEventSubscriber
{
    ...
    {
        if (!is_null($event->timer->timeable)) {
    ...
    {
        $events->listen('Modules\Timetracking\Events\TimerCreated', 'Modules\Timetracking\Listeners\TimerEventSubscriber@onTimerCreated');
        $events->listen('Modules\Timetracking\Events\TimerUpdated', 'Modules\Timetracking\Listeners\TimerEventSubscriber@onTimerUpdated');
        $events->listen('Modules\Timetracking\Events\TimerDeleted', 'Modules\Timetracking\Listeners\TimerEventSubscriber@onTimerDeleted');
    }
}
