        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    ...
                    <span class="help-block text-dark small"><strong>HH:MM:SS</strong> e.g 4:10:15 (4hrs, 10minutes and
                        15seconds)</span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div id="start_end" class="display-none">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group date">
                            <input type="text" class="form-control datetimepicker-input" value="{{ timePickerFormat(now()->addMinutes(5)) }}" name="start"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group date">
                            <input type="text" class="form-control datetimepicker-input" value="{{ timePickerFormat(now()->addMinutes(125)) }}" name="end"
                                data-date-format="{{ strtoupper(get_option('date_picker_format')) }} hh:mm A" data-date-start-date="0d" required>
                            <div class="input-group-addon">
                                @icon('solid/calendar-alt', 'text-muted')
                            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <textarea name="notes" class="form-control ta" placeholder="A short description, as to what is being billed."></textarea>
                </div>
            </div>
            <div class="form-group">
