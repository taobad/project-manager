    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="input-group date">
                        <input type="text" class="form-control datetimepicker-input" value="{{ timePickerFormat($todo->due_date) }}" name="due_date"
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <textarea class="form-control ta" name="notes">{{ $todo->notes }}</textarea>
                </div>
            </div>
