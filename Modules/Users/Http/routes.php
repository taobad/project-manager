...
Route::group(
    ...
    function () {
        ...
        Route::get('view/{user}/{tab?}', 'UserCustomController@view')->name('users.view')->middleware('can:menu_users');
        ...
        Route::post('bulk-verify', 'UserCustomController@bulkVerify')->name('users.bulk.verify')->middleware(['can:users_update', 'demo']);
        ...
        Route::get('/logged-in-devices', 'LoggedInDeviceController@index')->name('logged-in-devices.list')->middleware('demo');
        Route::get('/logout-all', 'LoggedInDeviceController@logoutAllDevices')->name('logged-in-devices.logout.all')->middleware('demo');
        Route::get('/logout-device/{device_id}', 'LoggedInDeviceController@logoutDevice')->name('logged-in-devices.logoutSpecific')->middleware('demo');
    }
);
