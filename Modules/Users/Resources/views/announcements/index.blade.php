      ...
      <section class="scrollable wrapper bg" id="announcements">
        ...
        <div class="form-group">
          ...
          <div class="input-group date">
            <input type="text" class="form-control datetimepicker-input" value="{{ timePickerFormat(now()->addMinutes(10)) }}" name="announce_at"
              data-date-format="{{ strtoupper(config('system.preferred_date_format')) }} hh:mm A" data-date-start-date="0d">
            ...
            <li class="panel panel-default" id="announcement-{{ $announcement->id }}">
              ...
              <div id="{{ slugify($announcement->subject) }}" class="panel-collapse collapse">
                <div class="panel-body message">
                  ...
                  <a class="btn {{themeButton()}}" href="{{ $announcement->url }}" target="_blank">Read More</a>
                  @endif
                </div>
              </div>
