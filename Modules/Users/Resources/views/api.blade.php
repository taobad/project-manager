      ...
      <section class="vbox">
        <header class="px-2 pb-2 bg-white border-b border-gray-400 panel-heading">
          <div class="flex justify-between text-gray-500">
            <div>
              <span class="text-xl font-semibold text-gray-600">Oauth Access</span>
            </div>
          </div>
        </header>
            ...
            <ul class="list no-style" id="responses-list">
              ...
              <li class="panel panel-default" id="tokenize">
                <div class="panel-heading">
                  ...
                  <a href="{{ route('oauth.refresh.token') }}" class="pull-right text-muted m-l-xs" data-toggle="ajaxModal" data-rel="tooltip" title="Create New Access token"
                    data-placement="left">@icon('solid/sync-alt')</a>
                </div>
