        ...
        <table class="table table-striped" id="tickets-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="label label-{{ priorityColor($ticket->AsPriority->priority) }}">@langapp(strtolower($ticket->AsPriority->priority))</span>
                    </td>
                    <td class="">{{ $ticket->dept->deptname }}</td>
                    <td>
                        <span class="label label-default">@langapp($ticket->AsStatus->status)</span>
                    </td>
