...
return [
    ...
    'webhooks' => [
         ...
         */
        'jobs' => [
            'payments_confirmed' => \Modules\Webhook\Jobs\GocardlessWebhooks\HandleConfirmedPayment::class,
            'payments_chargeback_settled' => \Modules\Webhook\Jobs\GocardlessWebhooks\HandleRefundPayment::class
        ],
    ],
];
