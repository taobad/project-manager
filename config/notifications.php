...
return [
    'alerts' => [
        ...
        'task_created'          => [
            'name'        => 'task_created',
            'description' => 'Notify me when am assigned a task',
        ],
        'estimate_commented'      => [
            'name'        => 'estimate_commented',
            'description' => 'Notify me when estimate receives a new comment',
        ],
        'creditnote_commented'      => [
            'name'        => 'creditnote_commented',
            'description' => 'Notify me when creditnote receives a new comment',
        ],
        'expense_commented'       => [
        ...
        'invoice_alert'           => [
            'name'        => 'invoice_alert',
            'description' => 'Send notification for invoice overdue alert',
        ],
        'ticket_assigned'         => [
        ...
        'project_assigned'         => [
            ...
            'description' => 'Notify me when a project is assigned to me',
        ],
        'ticket_closed_alert'     => [
        ...
        'ticket_status_alert'     => [
            'name'        => 'ticket_status_alert',
            'description' => 'Notify me when ticket status changes',
        ],
