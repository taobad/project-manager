...
return [
    'text' => [
        ...
        'dark' => 'text-gray-600 hover:text-gray-700',
    ...
    'button' => [
        ...
        'warning' => 'bg-transparent hover:bg-yellow-600 text-yellow-700 font-semibold hover:text-white py-1 px-2 border border-yellow-600 hover:border-transparent rounded',
        'dark' => 'bg-transparent hover:bg-gray-600 text-gray-700 font-semibold hover:text-white py-1 px-2 border border-gray-600 hover:border-transparent rounded',
