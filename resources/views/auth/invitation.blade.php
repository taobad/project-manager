...
<section id="content" class="wrapper-md content">
    ...
    <div id="login-form" class="container max-w-md aside-xxl animated fadeInUp">
        ...
        <section class="bg-white panel panel-default m-t-sm b-r-xs">
            <header class="px-2 py-3 text-center text-white {{themeBg()}} border-b border-gray-200 rounded-t-sm">{{ get_option('company_name') }} @langapp('invitation')</header>
            ...
            <button type="submit" class="btn {{themeButton()}} btn-block">@langapp('accept_invitation') </button>
