...
@langmail('invoices.sending.greeting', ['name' => $invoice->company->primary_contact > 0 ? $invoice->company->contact_person : $invoice->company->name])  

@langmail('invoices.sending.body', ['name' => get_option('company_name'), 'code' => $invoice->name, 'balance' => formatCurrency($invoice->currency, $invoice->due()), 'date' => $invoice->due_date->toDayDateTimeString()])
