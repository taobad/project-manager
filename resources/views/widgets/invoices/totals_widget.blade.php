<div class="row m-l-none m-r-none m-sm">
    <div class="col-sm-6 col-md-3 padder-v lt pallete b-b b-r">
        <a class="clear" href="{{ route('invoices.index') }}">
            ...
            <small class="text-uc" data-rel="tooltip"
                title="@langapp('invoiced') @langapp('today') {{ dateFormatted(today()) }}">@langapp('today')</small>
    ...
    <div class="col-sm-6 col-md-3 padder-v lt pallete b-b b-r">
        <a class="clear" href="{{ route('invoices.index') }}">
            ...
            <small class="text-uc" data-rel="tooltip"
                title="{{ dateFormatted(now()->startOfWeek()) }} - {{ dateFormatted(now()->endOfWeek()) }}">@langapp('this_week')</small>
    ...
    <div class="col-sm-6 col-md-3 padder-v pallete b-b b-r">
        <a class="clear" href="{{ route('reports.index', ['m' => 'invoices']) }}">
            ...
            <small class="text-uc" data-rel="tooltip" title="{{ dateFormatted(today()) }}">@langapp('paid')
                @langapp('today')</small>
    ...
    <div class="col-sm-6 col-md-3 padder-v pallete b-b">
        <a class="clear" href="{{ route('reports.index', ['m' => 'invoices']) }}">
            ...
            <small class="text-uc" data-rel="tooltip"
                title="{{ dateFormatted(now()->startOfWeek()) }} - {{ dateFormatted(now()->endOfWeek()) }}">@langapp('weekly')
                @langapp('income')</small>
