<section class="panel panel-default">
  <header class="font-bold panel-heading"><?php echo trans('app.'.'deals_by_stage'); ?>
...
<script>
  ...
  tooltipOptions: {
    ...
    formatTooltipY: d => parseFloat(d).toLocaleString('<?php echo e(get_option('locale')); ?>') + ' <?php echo e(get_option('default_currency')); ?>',
  }
  });
</script>
<?php $__env->stopPush(); ?><?php /**PATH /var/www/project-manager/resources/views/livewire/deal/stages-chart.blade.php ENDPATH**/ ?>