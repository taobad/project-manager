...
class EstimateTest extends TestCase
{
    ...
    {
        $this->getJson('/api/v1/estimates')->assertStatus(401);
    }

    public function test_create_without_authentication()
    {
        $this->postJson('/api/v1/estimates', [])->assertStatus(401);
    }
    ...
    public function test_crud_operations()
    {
        ...
        $payload = [
            ...
            'client_id' => $client_id,
            'currency' => 'USD',
            'due_date' => now()->addDays(14)->format(config('system.preferred_date_format')),
        ];
